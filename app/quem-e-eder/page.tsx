  ...
  return (
    <main className="internalPage" id="top">
      ...
      <section className="bioRecognition" id="reconhecimento">
        <div className="recognitionPhoto"><img src="/eder-quem-e-portrait.jpg" alt="Retrato de Eder Bublitz sorrindo" /></div>
      ...
      <footer className="bioFooter">
        ...
        <img src="/republicanos-logo-transparent.png" alt="Republicanos 10" />
      </footer>
