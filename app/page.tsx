    ...
    <main id="top">
      ...
      <section className="hero desktopHero" id="inicio">
        ...
        <div className="photoStage">
          <img src="/eder-hero-integral.png" alt="Eder Bublitz sorrindo e com os braços cruzados" />
        </div>
      ...
      <section className="mobileHero" aria-label="Eder Bublitz 1020">
        ...
        <img className="mobilePortrait" src="/eder-hero-integral.png" alt="Eder Bublitz sorrindo e com os braços cruzados" />
